...
# for aarch64
#export PATH=/extend/01-project/os-lab/gcc-linaro-4.9-2014.11-x86_64_aarch64-elf/bin/:$PATH
#export PATH=/home/lakshman/Acads/695_osdi/aarch64-toolchain/gcc-linaro-4.9-2014.11-x86_64_aarch64-linux-gnu/bin:$PATH
export PATH=/mnt/d/01-project/os-lab/gcc-linaro-4.9-2014.11-x86_64_aarch64-elf/bin:$PATH
